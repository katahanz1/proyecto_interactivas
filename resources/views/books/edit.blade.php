    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <x-form-card
                ...
                description="Modify book details and cover image"
            ...
            >
                <form action="{{ route('books.update', $book->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Author -->
                        <div>
                            <x-input-label for="author_id" value="Author" />
                            <select
                                id="author_id"
                                name="author_id"
                                class="input-base"
                    ...
                    @if($book->cover_image)
                        <div class="border border-primary-200 rounded-lg p-4 bg-primary-25">
                            <p class="text-sm font-semibold text-primary-900 mb-3">Current Cover Image</p>
                    ...
                    <!-- Cover Image Upload -->
                    <div>
                        <x-input-label for="cover_image" value="Update Cover Image" />
                        <div class="mt-2">
                            <input
                                type="file"
                                id="cover_image"
                                ...
                                class="block w-full text-sm text-primary-500
                                    ...
                                    transition-colors"
                            />
                            <p class="text-xs text-primary-500 mt-2">PNG, JPG or GIF (max. 5MB). Leave empty to keep current image.</p>
                        </div>
